...
void CGlock::Precache( void )
{
	...
	PRECACHE_MODEL( "models/v_silencer.mdl" );
	PRECACHE_MODEL( "models/w_9mmhandgun.mdl" );
	PRECACHE_MODEL( "models/w_silencer.mdl" );
	PRECACHE_MODEL( "models/p_9mmhandgun.mdl" );
	PRECACHE_MODEL( "models/p_silencer.mdl" );
...
{
	if( m_bSilenced )
		return DefaultDeploy( "models/v_silencer.mdl", "models/p_silencer.mdl", GLOCK_DRAW, "onehanded" );
	else
